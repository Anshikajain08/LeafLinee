...
export default function LoginPage() {
  ...
  return (
    <>
      <Header />
      <div className="flex items-center justify-center min-h-screen bg-[#c7c7c7] from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center w-full px-4 py-3 space-x-3 text-gray-700 transition-all duration-200 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
